...
CONFIG_DIR = Path("reproduce_table3/configs/sni_local")
MANIFEST_PATH = Path("reproduce_table3/configs/sni_local_manifest.yaml")
RESULTS_CSV = "reproduce_table3/results/table3_sni_local.csv"
...
def config_for(size_key: str, method: str) -> dict:
    ...
    return {
        ...
        "dataset_name": "allenai/natural-instructions-local",
        ...
        "training": {
            "output_dir": f"reproduce_table3/outputs/sni_local/{size_key}_{method}",
